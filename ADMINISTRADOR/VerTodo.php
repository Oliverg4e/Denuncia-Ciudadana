...
session_start();
 ...
 ?>
	...
	<?php if(isset($_SESSION['message'])){?>
		...
		$query = "select *from denuncias ORDER BY Fecha_Hora DESC  ";
			...
			case "fecha_d": 
			$query = "select *from denuncias ORDER BY Fecha_Hora ASC  ";
			break;

			case "tipo":
			$query ="select *from denuncias ORDER BY tipo DESC ";
			break;

			case "statusC": 
			$query ="select *from denuncias WHERE status='Completo' ORDER BY fecha_hora DESC   ";
			break;

			case "statusP": 
			$query ="select *from denuncias WHERE status='Pendiente' ORDER BY fecha_hora DESC ";
			break;

			case "usuario": 
			$query ="select *from denuncias ORDER BY idUsuario DESC  ";
			break;

			default: $query = "select *from denuncias ORDER BY Fecha_Hora DESC  ";
